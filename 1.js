...
const degreeС = Number.parseFloat(prompt(`Введите температуру в градусах Цельсия `));

alert(`Цельсий: ${degreeС}, Фаренгейт: ${translation(degreeС)}`);

function translation (С) {
    let f = (9 / 5) * С + 32;
